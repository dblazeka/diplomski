...
//	public void emailTest(Model model) {
//		emailService.sendEmail("dino.blazeka@gmail.com", "123");
//	}
	...
	public String generateForm(Model model, @PathVariable() String moduleName) {
		...
		if (module != null) {
			...
			model.addAttribute("moduleParameters", module
					.getParameterContainer().getParameters());
		} else {
			return "error";
		}
